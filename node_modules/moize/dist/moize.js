(function (global, factory) {
  ...
  var getSerializerFunction = function getSerializerFunction(options) {
    return (
      ...
      typeof options.serializer === 'function' ? // $FlowIgnore serializer is a function
  ...
  var createOnCacheOperation = function createOnCacheOperation(fn) {
    if (typeof fn === 'function') {
      return function (cache, _microMemoizeOptions, memoized) {
        return (// $FlowIgnore fn is a function if this is hit
  ...
  function moize(fn, options) {
    ...
    if (typeof fn === 'object') {
      return function (curriedFn, curriedOptions) {
        ...
        return (
          /* eslint-disable operator-linebreak */
          typeof curriedFn === 'function' ? // $FlowIgnore fn is actually an object of options
