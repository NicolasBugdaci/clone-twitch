...
function getWinstonConsole() {
    ...
    var _simple = simple();
    var myFormat = winston.format(function (info) {
        var stringifiedRest = processJSON(Object.assign({}, info, {
            level: undefined,
            message: undefined,
            splat: undefined
        }));
...
function waitForNodeJS(cb) {
    ...
    var Timer_constructor = process.binding('timer_wrap').Timer;
